...
I'm using a [Samsung Galaxy A21s](https://en.wikipedia.org/wiki/Samsung_Galaxy_A21s) with an Exynos chip, bought right here in Slovenia. The phone is carrier unlocked.
...
**WARNING:** The author shall not be liable for any misuse and/or any damage made to the device.
...
1. Open your Samsung phone dialer, type in **\*#1234#**.
...
**WARNING:** If Magisk suddenly crashes, it's best to relaunch it after a reboot and restart the process of patching the file. Patched file is probably corrupted and shall not be used and/or flashed,
...
**WARNING:** This **will** trip Samsung Knox eFuse and there's no way to undo it. Once you do this process,
...
**WARNING:** You might have to download additional drivers for Odin to detect your device.

**WARNING:** This might erase all of your data. Please make a backup beforehand.
...
**WARNING:** You must go through the entire setup process before continuing to Part 2.
...
**GSIs are only system images and don't come with a Boot image, therefore you cannot use the phhusson's GSI in Magisk app.**
